 ...
 const[liked,setLiked]=useState(false)
  ...
  return (
   ...
   <Text my={3}>Let's talk about threads.</Text>
      ...
      <Comment comment="Amazing" createdAt="1d" likes={21} username="janedoe" userAvatar="https://bit.ly/code-beast" />
      <Comment comment="Looks good" createdAt="2d" likes={42} username="sallydoe" userAvatar="https://bit.ly/sage-adebayo" />
    </>   
  )
}
